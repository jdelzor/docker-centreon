...
ADD https://s3-eu-west-1.amazonaws.com/centreon-download/public/centreon/centreon-2.5.2.tar.gz /root/nagios/
...
RUN sed -i -e"/^bind-address = localhost/a innodb_file_per_table = 1" /etc/mysql/my.cnf
